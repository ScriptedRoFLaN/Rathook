...
static settings::Button rapidfire_key{ "warp.rapidfire.key", "None" };
...
static settings::Button warp_key{ "warp.key", "None" };
static settings::Button charge_key{ "warp.charge-key", "None" };
